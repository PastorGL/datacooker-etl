    ...
    static public Highlight get(int tokenType) {
        return switch (tokenType) {
            ...
            case S_SCOL, K_ANALYZE, K_ANTI, K_AS, K_BEGIN, K_BY, K_CALL, K_COLUMNS, K_COPY, K_CREATE, K_DISTINCT,
                 K_DROP, K_DS, K_ELSE, K_END, K_FETCH, K_FROM, K_FUNCTION, K_IF, K_INNER, K_INPUT, K_INTO, K_JOIN,
                 K_KEY, K_LEFT, K_LET, K_LIMIT, K_LOOP, K_OPTIONS, K_OUTER, K_OUTPUT, K_PARTITION, K_PROCEDURE, K_RAISE,
                 K_RECORD, K_REPLACE, K_RETURN, K_RIGHT, K_SELECT, K_SET, K_SOURCE, K_THEN, K_TRANSFORM, K_ALTER,
                 K_UNION, K_WHERE, K_YIELD -> KEYWORD;
            case S_NULL -> NULL;
            case S_FALSE, S_TRUE -> BOOLEAN;
            case T_MSGLVL, T_OBJLVL, T_SIMPLE, T_STREAM_TYPE -> TYPE;
