...
public class TextOutputFunction extends PartOutputFunction {
    protected final String[] columns;
    protected final char delimiter;

    public TextOutputFunction(String sub, String outputPath, HadoopStorage.Codec codec, String[] columns, char delimiter) {
