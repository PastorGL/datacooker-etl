    ...
    static public Highlight get(int tokenType) {
        return switch (tokenType) {
            ...
            case S_SCOL, K_ANALYZE, K_ANTI, K_AS, K_BEGIN, K_BY, K_CALL, K_COLUMNS, K_COPY, K_CREATE, K_DISTINCT,
                 ...
                 K_LET, K_LIMIT, K_LOOP, K_OPTIONS, K_OUTER, K_OUTPUT, K_PARTITION, K_PROCEDURE, K_RECORD, K_REPLACE,
                 K_RETURN, K_RIGHT, K_SELECT, K_SET, K_SOURCE, K_THEN, K_TRANSFORM, K_UNION, K_WHERE -> KEYWORD;
            case S_NULL -> NULL;
